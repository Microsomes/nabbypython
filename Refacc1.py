...
def pick_difficulty():
    Difficulty = input(
        " To choose difficulty input a number \n Easy: 1 \n Hard: 2 \n Very Hard: 3 \n ")
    return Difficulty
...
def encounter3():
    ...
    if userOption == "1":
        ...
        if findInventoryItem("victual"):
            ...
            print(
                " You run out of supplies quickly and starve after failing to find more food. \n GAME OVER ")
        print(" ")
    elif userOption == "3":
        print(" ")
